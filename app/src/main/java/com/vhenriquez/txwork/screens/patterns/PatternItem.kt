        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .width(10.dp)
                    .height(92.dp)
                    .background(getColor(pattern.certificate.broadcastDate))
            )
            Column(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                TextSpannable(textSpannable = R.string.card_patternBrand, text = pattern.brand, modifier = Modifier)
                TextSpannable(textSpannable = R.string.card_patternSerial, text = pattern.serial, modifier = Modifier)
                TextSpannable(textSpannable = R.string.card_certificateId, text = pattern.certificate.certificateId, modifier = Modifier)
            }
        }
