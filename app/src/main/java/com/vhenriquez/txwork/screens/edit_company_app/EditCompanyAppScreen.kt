...
@Composable
fun EditCompanyAppScreen(
    popUp: () -> Unit,
    viewModel: EditCompanyAppViewModel = hiltViewModel()){

    EditCompanyAppScreenContent(
        viewModel = viewModel,
        popUp = popUp,
        onDismiss = {popUp()}
    )
...
@Composable
fun EditCompanyAppScreenContent(
    viewModel: EditCompanyAppViewModel,
    popUp: () -> Unit,
    onDismiss: () -> Unit,
){
